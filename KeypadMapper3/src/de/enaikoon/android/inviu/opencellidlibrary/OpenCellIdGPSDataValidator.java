...
public class OpenCellIdGPSDataValidator {
	/**
	 ...
	 * NOTE: for OpenCellID needs - less than 17 meters
	 * @return true if the accuracy is smaller than 17 meters, false otherwise
	 */
	private static boolean checkAccuracy(Location location)	{
	    if (location.getAccuracy() < 17) {
	        return true;
	    } else {
	        return false;
	    }
	...
	private static Boolean checkAltitude(Location location)	{
		if (location.getAltitude() > 15000 || location.getAltitude() < -500) {
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = false | " + location.getAltitude());
			return false;
		...
		if (lastRecodedLocation == null) {
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = true | lastRecodedLocation==null");
			return true;
		} else if (location.getTime() == lastRecodedLocation.getTime())	{
			return true;
		} else if (location.getLatitude() == 0 && location.getLongitude() == 0)	{
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = false | lat=0 lng=0");
			return false;
		} else {
			...
			if (delta_time == 0) {
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = true | delta_time: " + delta_time + " ... distance: " + distance);
				return true;
			}		
			...
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = false | " + speedMS + " | " + distance);

				return false;
			} else
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAltitude() = true | " + speedMS + " | " + distance);
	...
	public static Boolean checkValidDistance(Location location)
	{
		try
		{
			if (lastRecodedLocation == null)
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkValidDistance() = true | lastRecodedLocation==null");

				return true;
			} else if (location.distanceTo(lastRecodedLocation) < 5)
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkValidDistance() = false | " + location.distanceTo(lastRecodedLocation));
				return false;
			} else
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkValidDistance() = true | " + location.distanceTo(lastRecodedLocation));

				return true;
			}
		} catch (Exception ex)
		{
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkValidDistance() = false | error");
	...
	private static Boolean checkAcceleration(Location location)
	{
		try
		{
			if (lastRecodedLocation == null)
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = true | lastRecodedLocation==null");
			...
			{
				Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = false | lat=0 lng=0");
				return false;
			} else
			{
				if (location.getTime() < lastRecodedLocation.getTime())
				{
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = false | " + location.getTime() + " < "
				...
				if (delta_time == 0)
				{
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = true | delta_time: " + delta_time + " ... distance: " + distance + logvalue);
				...
				{
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = false | " + acceleration + logvalue);
					
					return false;
				} else
				{
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = true | " + acceleration + logvalue);
		...
		{
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Method: " + OpenCellIdGPSDataValidator.class.getPackage().getName() + ".checkAcceleration() = false | error");
			//AppMain.writeExceptionToLog(ex);
			return false;
		}
	}
	 ...
	 *  
	 *  NOTE: for OpenCellID = 4 sattelites or more are valid for a fix
	 *  
	 * @param numberOfUsedSatellites
	 * @return true if the number of used satellites is greater than 4, false
	 *         otherwise
	 */
	private static boolean gpsFixCheck(int numberOfUsedSatellites)
	{
		return (numberOfUsedSatellites >= 4) ? true : false;
	}
	...
	private static boolean latlngCheck(Location newLocation)
	{
		...
		{
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "LatLng check invalid: LAT=0; LNG=0");
			return false;
		}
	}
	...
	private static boolean omitValidGPSData()
	{
		if (omitValidGPSData > 0)
		{
			...
			Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "OpenCellIdGPSDataValidator() LOCATION OMITTED! " + omitValidGPSData);
		...
		if (latlngCheck(newLocation))
		{
			if (gpsTimeCheck(lastValidLocation, newLocation))
			{
				if (gpsFixCheck(fix))
				{
					if (checkAcceleration(newLocation))
					{
						if (checkAltitude(newLocation))
						{
							...
							{
								Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Accuracy check valid: " + newLocation.getAccuracy());
								
								if (checkDOPValues(HDOP, VDOP))
								{
									Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "DOP check valid: HDOP: " + NMEAHelper.HDOP + " | VDOP: " + NMEAHelper.VDOP);
								...
								{
									Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "DOP check failed: HDOP: " + NMEAHelper.HDOP + " | VDOP: " + NMEAHelper.VDOP);

									//GPSDataLog.writeToLog(newLocation, false);

									Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "PREPARE LOCATION OMITTING: 1 | DOP");

									omitValidGPSData = 3;
								}
							} else
							{
								Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Accuracy check failed: " + newLocation.getAccuracy());

								//GPSDataLog.writeToLog(newLocation, false);

								Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "PREPARE LOCATION OMITTING: 2 | ACCURACY");
						...
						{
							Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "Altitude check failed: " + newLocation.getAltitude());

							//GPSDataLog.writeToLog(newLocation, false);

							Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "PREPARE LOCATION OMITTING: 3 | ALTITUDE");
					...
					} else
					{
						...
						Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "PREPARE LOCATION OMITTING: 4 | ACCELERATION");
				...
				} else
				{
					...
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), "PREPARE LOCATION OMITTING: 5 | FIX=" + fix);
			...
			} else
			{
				...
				try
				{
					...
					Log.d(OpenCellIdGPSDataValidator.class.getPackage().getName(), log);
				} catch (Exception ex)
				{
				}
			}
